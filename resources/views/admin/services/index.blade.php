            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.services.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.services.create') }}" class="btn btn-success addMembers-modal">
                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th scope="col">{{__('admin.count_subservices')}}</th>
                                ...
                                <tbody>
                                    @forelse ($services as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('admin.services.show', $item->slug) }}">{{ $item->title }}</a></td>
                                            <td>{{ $item->slug }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.services.show', $item->slug) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.services.destroy', $item->slug) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
