            ...
            <div class="card">
              <div class="card-body">
                <div class="card-header align-items-center d-flex card-title">
                    <h4 class="mb-0 flex-grow-1 text-white">{{ __('admin.new_service_child_card_title') }}</h4>
                    <a href="{{ route('admin.services.show', $service_parent->slug) }}" class="btn btn-secondary mb-3">
