            ...
            <div class="card">
              <div class="card-body">
                <div class="card-header align-items-center d-flex card-title">
                        <h4 class="mb-0 flex-grow-1 text-white">{{ __('admin.service_card_title') }}:
                                {{ $item->title }}</h3>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                                    ...
                                    <li>
                                        <a type="button" class="dropdown-item"
                                            href="{{ route('admin.services.show', $parent->slug) }}">
                                    ...
                                    <li><a href="{{ route('admin.services.edit_child', [$parent->slug, $item->slug]) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="{{ route('admin.services.destroy_child', [$parent->slug, $item->slug]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
