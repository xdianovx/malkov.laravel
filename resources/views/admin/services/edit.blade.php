    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <div class="card-header align-items-center d-flex card-title">
                    <h4 class="mb-0 flex-grow-1 text-white">{{ __('admin.edit_service_card_title') }}: {{ $item->title }}
                    </h4>
                    <a href="{{ route('admin.services.show', $item->slug) }}" class="btn btn-secondary mb-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.services.update', $item->slug) }}" method="POST"
