            ...
            <div class="card">
              <div class="card-body">
                <div class="card-header align-items-center d-flex card-title">
                        <h4 class="mb-0 flex-grow-1 text-white">{{ __('admin.review_card_title') }}:
                                {{ $item->title }}</h3>
                            ...
                            <div class="dropdown">
                             ...
                             Действия <i class="ri-more-2-fill fs-14"></i>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                                    ...
                                    <li>
                                        <a type="button" class="dropdown-item" href="{{ route('admin.reviews.index') }}">
                                            <i class="ri-arrow-left-line align-bottom me-2 text-muted"></i>
                                            {{ __('admin.btn_back') }}</a>
                                    </li>

                                    <li><a href="{{ route('admin.reviews.edit', $item->id) }}"
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                @if($item->specialist_id != null)
                                    <tr>
                                        <th class="ps-0" scope="row">{{ __('admin.field_specialist') }}:</th>
                                        <td class="text-muted">{{ $item->specialist->title }}</td>
                                    </tr>
                                @endif
                                <tr>
                                ...
                                <tr>
                                    <th class="ps-0" scope="row">{{ __('admin.field_rating') }}:</th>
                                    <th class="text-muted fs-16">
