            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.reviews.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.reviews.create') }}" class="btn btn-success addMembers-modal">
                                ...
                                <tbody>
                                    @forelse ($reviews as $item)
                                        <tr>
                                            ...
                                            <td><a
                                                    href="{{ route('admin.reviews.show', $item->id) }}">{{ $item->title }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.reviews.show', $item->id) }}"
