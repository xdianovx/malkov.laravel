            ...
            <div class="card">
              <div class="card-body">
                <div class="card-header align-items-center d-flex card-title">
                    <h4 class="mb-0 flex-grow-1 text-white">{{ __('admin.edit_stock_card_title') }}: {{ $item->title }}</h4>
                    <a href="{{ route('admin.stocks.show', $item->slug) }}" class="btn btn-secondary mb-3">
                            ...
                            <div class="row gy-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" class="form-control" name="due_time"
                                        value="{{ $item->due_time }}" id="exampleInputdate">
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div>
