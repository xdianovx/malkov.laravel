                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="flex-grow-1">
                            <h3 class="card-header align-items-center d-flex">{{ __('admin.stock_card_title') }}:
                                {{ $item->title }}</h3>
                        </div>
                        <div class="flex-shrink-0">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                                    style="">
                                    <li>
                                        <a type="button" class="dropdown-item" href="{{ route('admin.stocks.index') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th class="ps-0" scope="row">{{ __('admin.due_time') }}:</th>
                                    <td class="text-muted">{{ $item->due_time }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('admin.stocks.destroy', $item->slug) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
