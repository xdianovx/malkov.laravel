        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{__('admin.new_modern_office_card_title')}}</h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.blocks.modern_offices.store', $block->id ) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
