        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.edit_category_blog_card_title') }}
                        {{ $item->title }}</h4>
                </div>
                        ...
                        <form action="{{ route('admin.categories_blog.update', $item->slug) }}" method="POST"
                            ...
                            <div class="row gy-4">
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <textarea class="form-control ckeditor-classic" name="description_footer"
                                        placeholder="{{ __('admin.placeholder_text') }}" style="height: 234px;">{!! $item->description_footer !!}</textarea>
                                </div> --}}
                            </div>
                            <button type="submit"
