        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.edit_show_reel_card_title') }} {{ $item->title }}
                    </h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.pages.show_reels.update', [$item->page->slug, $item->id]) }}" method="POST"
            ...
            <div class="card">
                <div class="card-body">
                    @if (!empty($files['video']))
                        ...
                        <div class="d-flex mb-4">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="{{ $files['video'] }}"
                                    allowfullscreen></iframe>
                            </div>
                        </div>
                    @else
