            ...
            <div class="card">
              <div class="card-body">
                <div class="card-header align-items-center d-flex card-title">
                    <h4 class="mb-0 flex-grow-1 text-white">{{__('admin.edit_number_card_title')}} {{ $item->title }}</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.pages.home_page_nums.update',[$page->slug , $item->id]) }}" method="POST"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" value="{{ $item->label }}" class="form-control"
