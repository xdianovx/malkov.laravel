            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header align-items-center d-flex card-title">
                        <h4 class="mb-0 flex-grow-1 text-white">{{ __('admin.edit_document_card_title') }} {{ $item->title }}
                        </h4>
                        <a href="{{ route('admin.specialists.show', $specialist->slug) }}" class="btn btn-secondary mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="live-preview">
                            <form action="{{ route('admin.specialists.documents.update', [$specialist->slug, $item->id]) }}"
                                ...
                                <div class="row gy-4">
                                    <div class="col-xxl-6 col-md-6">
                                        <div>
                                            <label for="valueInput" class="form-label">{{ __('admin.field_title') }}
                                                *</label>
