            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header align-items-center d-flex card-title">
                            <h3 class=" mb-0 flex-grow-1 text-white">{{ __('admin.document_card_title') }}:
                                {{ $item->title }}</h3>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                                    ...
                                    <li>
                                        <a type="button" class="dropdown-item"
                                            href="{{ route('admin.specialists.show', $item->specialist->slug) }}">
                                            <i class="ri-arrow-left-line align-bottom me-2 text-muted"></i>
                                            {{ __('admin.btn_back') }}</a>
                                    </li>

                                    <li><a href="{{ route('admin.specialists.documents.edit', [$item->specialist->slug, $item->id]) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="{{ route('admin.specialists.documents.destroy', [$item->specialist->slug, $item->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
