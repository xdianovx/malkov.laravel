    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <div class="card-header align-items-center d-flex card-title">
                    <h4 class="mb-0 flex-grow-1 text-white">{{ __('admin.edit_clinic_documents_card_title') }}: {{ $item->title }}</h4>
                    <a href="{{ route('admin.clinic_documents.show', $item->id) }}" class="btn btn-secondary mb-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.clinic_documents.update', $item->id) }}" method="POST"
