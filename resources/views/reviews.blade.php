                        ...
                        <div class="stock-item__bottom">
                            ...
                            <div class="rating flex items-center">
                                @for ($i = 1; $i <= $item->rating; $i++)
                                    <span class="star {{ $i <= $item->rating ? 'fill-[#FFCC00]' : '' }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            class="{{ $i <= $item->rating ? 'fill-[#FFCC00]' : '' }}" viewBox="0 0 24 24"
                                            stroke="currentColor" stroke-width="1" stroke="#FFCC00" stroke-linecap="round"
