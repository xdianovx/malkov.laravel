        ...
        <div class="callback-wrap">
            ...
            <div class="callback__right">
                ...
                <form class="callback-form" id="callbackForm"  action="{{ route('request_modal_section') }}">
                    ...
                    <p class="form-policy">
                        Нажимая кнопку “Записаться”, вы соглашаетесь с нашей <a href="/politika-konfidencialnosti">политикой
...
<script>
    document.getElementById('callbackForm').addEventListener('submit', function(event) {
        ...
        .catch(error => {
            ...
            document.getElementById('callback_error_section').innerText = 'Произошла ошибка повторите попытку позже!';
        });
    });
</script>
